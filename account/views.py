...
def register(request):
    ...
    first_name = data.get('first_name', '')  # Provide an empty string if 'first_name' is not in the data.
    last_name = data.get('last_name', '')  # Provide an empty string if 'last_name' is not in the data.
