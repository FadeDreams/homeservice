    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serviceType', models.CharField(choices=[('Permanent', 'Permanent'), ('Temporary', 'Temporary'), ('Intership', 'Intership')], default='Permanent', max_length=10)),
                ...
                ('experience', models.CharField(choices=[('No Exp', 'No Exp'), ('1 Years', 'One Year'), ('2 Years', 'Two Year'), ('3 Years above', 'Three Year Plus')], default='No Exp', max_length=20)),
                ...
                ('lastDate', models.DateTimeField(default=service.models.return_date_time)),
